...
<head>
    ...
    <style>
        ...
        .stat-icon {
            width: 50px; height: 50px; background-color: var(--light-green-bg);
            color: var(--primary-green); border-radius: 12px; display: flex;
            align-items: center; justify-content: center; font-size: 1.5rem; margin-bottom: 20px;
        }
        .stat-value { font-size: 1.8rem; font-weight: 700; color: #1f1f1f; margin-bottom: 5px; }
        .stat-label { color: var(--grey-text); font-size: 0.9rem; font-weight: 500; }

        /* Table Style */
        .table-custom { background: white; border-radius: 15px; overflow: hidden; box-shadow: 0 5px 15px rgba(0,0,0,0.03); }
        .table-custom thead { background-color: var(--dark-green-bg); color: white; }
        .table-custom th { padding: 15px 20px; font-weight: 500; border: none; }
        .table-custom td { padding: 15px 20px; vertical-align: middle; border-bottom: 1px solid #f0f0f0; color: #555; }
        
        .avatar-initial {
            width: 35px; height: 35px; background-color: #e9ecef; color: var(--dark-green-bg);
        ...
        /* Search Box */
        .search-box input {
            border-radius: 50px 0 0 50px; border: 1px solid #ddd; padding-left: 20px;
        }
        .search-box button {
            border-radius: 0 50px 50px 0; background-color: var(--dark-green-bg); color: white; border: none;
        }
