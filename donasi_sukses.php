...
<head>
    ...
    <style>
        ...
        .progress-bar-fill { height: 100%; background-color: var(--primary-green); width: 100%; border-radius: 10px; }
        ...
        .success-icon { color: white; font-size: 40px; }

        .success-title { font-family: 'Inria Serif', serif; font-weight: 700; font-size: 28px; text-align: center; margin-bottom: 15px; }
        .success-subtitle { text-align: center; color: #666; font-size: 14px; max-width: 500px; margin: 0 auto 40px; line-height: 1.6; }
        ...
        .receipt-title { font-family: 'Inria Serif', serif; font-weight: 700; font-size: 16px; margin-bottom: 20px; padding-bottom: 5px; }
        .receipt-row { display: flex; justify-content: space-between; margin-bottom: 12px; font-size: 13px; color: #555; }
        .receipt-divider { border-top: 1px solid #eee; margin: 15px 0; }
        .receipt-row.total { font-weight: 700; color: #000; font-size: 15px; margin-top: 5px; }

        /* --- Impact Box --- */
        .impact-box {
            background-color: #F7C35F; border-radius: 8px; padding: 15px; 
            margin-top: 20px; font-size: 12px; color: #5D4008; line-height: 1.5;
        }
        .impact-box strong { display: block; margin-bottom: 3px; font-size: 13px; font-weight: 700; color: #3E2B05; }

        /* --- Buttons --- */
        .btn-sertifikat {
            background-color: #4CAF50; color: white; border-radius: 50px; 
            padding: 12px 30px; font-weight: 600; border: none;
            display: block; margin: 0 auto 20px; transition: 0.3s; 
            text-decoration: none; width: fit-content; font-size: 14px;
        }
        .btn-sertifikat:hover { background-color: #3e8e41; color: white; }
        
        .btn-home {
            background-color: white; color: #999; border: 1px solid #ccc; 
            border-radius: 50px; padding: 8px 25px; font-size: 13px; 
